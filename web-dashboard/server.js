...
const revenueTransfer = require('./src/revenue-transfer');
app.use('/api/revenue', revenueTransfer);
...
// Bank setup page
app.get('/bank-setup', requireAuth, (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'bank-setup.html'));
});
...
server.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`💻 Local access: http://172.20.6.39:${PORT}/login`);
  console.log(`💻 Localhost access: http://localhost:${PORT}/login`);
});